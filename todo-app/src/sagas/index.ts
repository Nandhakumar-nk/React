...
import {
  addCategory,
  fetchCategory,
  getCategoriesAndImportantTasks,
} from "./categories";
...
export function* rootSaga() {
  ...
  yield takeEvery(
    ACTION_TYPES.FETCH_DEFAULT_CATEGORY_REQUEST,
    getCategoriesAndImportantTasks
  );
  ...
  yield takeEvery(
    ACTION_TYPES.GET_CATEGORIES_AND_IMPORTANT_TASKS,
    getCategoriesAndImportantTasks
  );

  yield takeEvery(
    ACTION_TYPES.CREATE_CATEGORY_SUCCESS,
    getCategoriesAndImportantTasks
  );
  yield takeEvery(
